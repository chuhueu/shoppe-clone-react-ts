                    ...
                    <Grid item lg={6}>
                        ...
                        >
                            ...
                            <Typography variant="overline">
                                Nền tảng thương mại điện tử yêu thích ở Đông Nam
                                Á & Đài Loan
                            </Typography>
                        </Box>
                    </Grid>
                    <Grid item lg={6}>
                        ...
                        >
                            <Box className={classes.styleLogin}>
                                ...
                                >
                                    <p className={classes.styleHeadingText}>
                                        Đăng Nhập
                                    </p>
                                    <Box
                                        display="flex"
                                ...
                                <form className={classes.styleForm}>
                                    ...
                                    >
                                        <Link
                                            to="#"
                                            className={classes.styleLinkOther}
                                        >
                                            Quên mật khẩu
                                        </Link>
                                        <Link
